    ...
    echo '<ul class="nav nav-treeview" hidden>
          ...
          ?>
                    ...
                    <label for="exampleInputPassword1">Select Result Year.:</label>
                        <input type="number" id="sbjyear" name="sbjyear" class="form-control" placeholder="e.g 2020">
                      </div>

                      <button type="button" id="chkres" class="btn btn-danger btn-outline-light">Check Result</button>
                      <button type="button" id="resres" class="btn btn-dark btn-outline-light">View All Results</button>
                </form>
              </div>
              <!-- /.card-body -->
